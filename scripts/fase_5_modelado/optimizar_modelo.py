...
def main():
    ...
    parser.add_argument(
        "--target", type=str, default="riesgo_fichaje", help="Columna objetivo"
    )
    parser.add_argument(
        "--n_jobs", type=int, default=-1, help="Cores para paralelización (-1 = todos)"
    )
    ...
    f1_test = evaluar_en_test_holdout(
        grid_search.best_estimator_, df_test, feats, args.target
    )
